...
def get_filters():
    ...
    while True:
        city = ''
        map_city = {'1':'chicago', '2': 'new york city', '3':'washington'}
        user_input = input('Choose city \'Chicago\' by entering 1\n           \'New York City\' by entering 2\n           \'Washington\' by entering 3\n ')
        if user_input in ['1','2','3']:
            city = map_city[user_input]
            break
        else:
...
def user_stats(df, city):
    ...
    if city != 'washington':
        ...
        earliest_birth = sorted(df.groupby(['Birth Year'])['Birth Year'])[0][0]
    ...
    while True:
        ...
        if raw.lower() == 'yes':
        	# You can also set columns limit from here.
